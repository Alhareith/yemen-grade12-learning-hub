...
const PROFILE_IMAGE_URL = "/manus-storage/alhareth-profile_8defaac7.jpg";
    ...
    <div dir="rtl" className="app-screen min-h-screen overflow-x-hidden text-[#17354a]">
      ...
      <main>
        <section className="mx-auto max-w-7xl px-4 pt-5 sm:px-6 sm:pt-9 lg:px-8">
          <div className="hero-paper app-hero relative overflow-hidden"><img src={HERO_URL} alt="دفتر ومصادر تعليمية" className="hero-image" fetchPriority="high" decoding="async" /><div className="hero-shade" />
